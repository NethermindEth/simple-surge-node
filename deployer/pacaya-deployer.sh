...
echo "=========================================="
echo "  Pacaya (Pacaya) Protocol Deployment"
echo "=========================================="
...
./setup.sh && forge script ./script/layer1/based/DeployProtocolOnL1.s.sol:DeployProtocolOnL1 --private-key $CONTRACT_OWNER_PRIVATE_KEY --fork-url $L1_ENDPOINT_HTTP --broadcast --ffi -vvv --block-gas-limit 200000000
cp /app/deployments/deploy_l1.json /deployments/deploy_l1_pacaya.json
