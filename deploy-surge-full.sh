...
generate_l2_genesis() {
    ...
    # Pass --Surge.L1EthApiEndpoint so the L1 precompile plugin initializes successfully
    # when the chainspec has rip7728/l1staticcall transition timestamps set. The genesis
    # hash itself doesn't need a live L1 — this is just the config validation.
